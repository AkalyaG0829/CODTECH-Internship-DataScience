...
**📂 Folder:** `Task1_DataPipeline/Task1_ETL/`  

---

## 📁 Task 2 – IMDb Sentiment Analysis (LSTM)  
...
**📂 Folder:** `Task2_NLP_Sentiment/`  

---

## 📁 Task 3 – End-to-End Sentiment Analysis Project (Flask UI + API)  
